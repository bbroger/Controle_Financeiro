        ...
        <body>
            <header id="cabecalho">
                <?php 
                    ...
                    require_once('arquivos/excluir.php');
                    require_once('arquivos/pagar.php'); 
                ?>    
            </header>
            <div id="corpo">
                <div id="lateral">
                ...
                <?php
                    require_once("arquivos/tabela.php"); ?>
                    <div id="piechart_3d" style="width: 300px; height: 300px;"> </div>
                    <div id="piechart_3d2" style="width: 300px; height: 300px;"> </div>
                    <?php require_once("arquivos/graficos.php");  ?>
                </div>                  <!--Fim div central-->
                <footer id="rodape">
